...
exports.serveMatches = function(req, res){
  ...
  console.log('serveMatches triggered'); 
  var match = new Match()
...
exports.postMatches = function(request, response) {
  ...
  console.log('postMatches triggered');
  ...
  // id is in user_1_id
  var alreadyInOrder = request.mydata.user.fb_id < query.target_id;
  var low_id = alreadyInOrder ? request.mydata.user.fb_id : query.target_id;
  var high_id = alreadyInOrder ? query.high_id : request.mydata.user.fb_id;
...
exports.serveCandidates = function(request, response){
  ...
  var oppositeGender = user.attributes.is_male ? 1 : 0;
  Users
