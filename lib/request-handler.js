...
exports.postMatches = function(request, response) {
  ...
  var high_id = alreadyInOrder ? query.high_id : request.mydata.user.attributes.fb_id;
...
exports.serveCandidates = function(request, response){
  ...
  console.log('user', user, 'is_male', typeof user.attributes.is_male,user.attributes.is_male);
